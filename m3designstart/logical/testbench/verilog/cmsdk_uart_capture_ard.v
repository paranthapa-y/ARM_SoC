  ...
  if (~RESETn)
    ...
    if (char_received)
        ...
        if ((rx_shift_reg[8:1]==8'h1B) | reg_esc_code_mode | reg_aux_ctrl_mode )
		  ...
		  $write("I am from uart data recpetor");
          // Escape code, or in escape code mode
          // Data receive can be command, aux ctrl data
          // Ignore this data
          end
	  else if  (rx_shift_reg[8:1]==8'h04) begin // Stop simulation if 0x04 is received
	

	//you have changed it here	  
